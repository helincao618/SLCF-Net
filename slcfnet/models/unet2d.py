...
class DecoderBN(nn.Module):
    ...
    def forward(self, features):
        x_block0, x_block1, x_block2, x_block3, x_block4 = (
            features[4],    #Output feature 4: torch.Size([1, 32, 185, 610])
            features[5],    #Output feature 5: torch.Size([1, 48, 93, 305])
            features[6],    #Output feature 6: torch.Size([1, 80, 47, 153])
            features[8],    #Output feature 8: torch.Size([1, 224, 24, 77])
            features[11],   #Output feature 11: torch.Size([1, 2560, 12, 39])
        )
        bs = x_block0.shape[0]
        ...
        if self.use_decoder:
            ...
            return {
                ...
                '1_16': self.resize_output_1_16(x_1_16),  # 1-16 is not used not peojected to 3d
            }
        else:
            x_1_1 = features[0]
